...
@section('content')
    ...
    <div class="card-header d-flex flex-wrap justify-content-center justify-content-xl-between mb-3" 
         data-aos="fade-right" 
         data-aos-delay="100" 
                    ...
                    @forelse ($data as $index => $k)
                        <tr>
                            ...
                            <td class="text-center">
                                <img src="{{ asset('storage/' . $k->gambar_kontrakan) }}" alt="Gambar" width="60" class="rounded shadow-sm">
                            </td>
                            ...
                            <td class="text-center">
                                <div class="d-flex justify-content-center gap-1">
                                    <a href="{{ route('admin.kontrakan.show', $k->id) }}" class="btn btn-info btn-sm text-white">
                                        <i class="bi bi-eye-fill"></i>
                                    </a>
                                    <a href="{{ route('admin.kontrakan.edit', $k->id) }}" class="btn btn-warning btn-sm">
                                        <i class="bi bi-pencil-square"></i>
                                    </a>
                                    <form action="{{ route('admin.kontrakan.destroy', $k->id) }}" method="POST" onsubmit="return confirm('Hapus data ini?')">
                                        @csrf
                                        @method('DELETE')
                        ...
                        <tr>
                            <td colspan="9" class="text-center py-5">
                                <div class="d-flex flex-column align-items-center">
                                    ...
                                    <small class="text-muted">Silahkan klik tombol "Tambah data" untuk mengisi kontrakan baru.</small>
                                </div>
                            </td>
                        </tr>
                    @endforelse
