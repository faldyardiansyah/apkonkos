                    ...
                    @forelse ($data as $index => $k)
                        <tr>
                            ...
                            <td class="text-center">
                                <img src="{{ asset('storage/' . $k->gambar_kosan) }}" alt="Gambar kosan" width="60" class="rounded shadow-sm">
                            </td>
                            ...
                            <td class="text-center">
                                <div class="d-flex justify-content-center gap-1">
                                    ...
                                    <form action="{{ route('admin.kosan.destroy', $k->id) }}" method="POST" onsubmit="return confirm('Yakin ingin menghapus?')">
                                        @csrf @method('DELETE')
                        ...
                        <tr>
                            <td colspan="9" class="text-center py-5">
                                <div class="d-flex flex-column align-items-center">
                                    ...
                                    <small class="text-muted">Silahkan klik tombol "Tambah data" untuk mengisi kosan baru.</small>
                                </div>
                            </td>
                        </tr>
                    @endforelse
