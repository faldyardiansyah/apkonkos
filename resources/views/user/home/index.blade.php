        ...
        <main>
            <section id="hero" class="hero" style="background-image: url('{{ asset('image/hero.png') }}');">
                ...
                <div class="container hero-content">
                    ...
                    <h1 class="hero-title">
                        <span style="display: block;" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="200">
                            Temukan Tempat Tinggal Sementara
                        </span>
                        <span style="display: block; color: #your-color;" data-aos="fade-up" data-aos-duration="1000"
                            data-aos-delay="400">
                            Impian Anda!
                        </span>
                    </h1>
